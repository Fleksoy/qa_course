...
class ProductPage(BasePage):
    ...
    def message_is_disappeared(self):
        assert self.is_disappeared(*ProductPageLocators.MESSAGE_SUCCESS), "Message is present"

    def message_is_not_present(self):
        assert self.is_not_element_present(*ProductPageLocators.MESSAGE_SUCCESS), "Message is present"